 ...
 * </p>
 * <ul>
 *   <li>{@link library.impl.WriterImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link library.impl.WriterImpl#getLastName <em>Last Name</em>}</li>
...
public class WriterImpl extends MinimalEObjectImpl.Container implements Writer {
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.WRITER__FIRST_NAME, oldFirstName, firstName));
	}
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.WRITER__LAST_NAME, oldLastName, lastName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LibraryPackage.WRITER__FIRST_NAME:
				return getFirstName();
			case LibraryPackage.WRITER__LAST_NAME:
				return getLastName();
			case LibraryPackage.WRITER__BOOKS:
				return getBooks();
		}
